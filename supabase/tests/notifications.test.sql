...
insert into public.notifications(user_id,type,title,message,dedupe_key,created_at) select '91111111-1111-4111-8111-111111111111','system','QA','QA','cap:'||i,'2026-03-09 18:00-05' from generate_series(1,20) i;select is((private.generate_user_reminders('91111111-1111-4111-8111-111111111111','2026-03-09 20:00-05')->>'inserted')::int,0,'Daily rolling cap enforced');
