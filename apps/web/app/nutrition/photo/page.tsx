...
export default async function FoodPhotoPage(){
 const client=(await createClient());await requireUser(client);const allowed=hasFeature(await getCurrentEntitlements(client),'ai_food_photo');const mode=foodPhotoMode();
