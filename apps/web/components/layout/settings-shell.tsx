...
const links = [{ key: 'account', label: 'Delete account', href: '/settings/account' }, { key: 'notifications', label: 'Notifications', href: '/settings/notifications' }, { key: 'profile', label: 'Profile', href: '/settings/profile' }, { key: 'goals', label: 'Goals & targets', href: '/settings/goals' }, { key: 'billing', label: 'Billing', href: '/settings/billing' }] as const;

export function SettingsShell({ active, children }: { active: 'account' | 'profile' | 'goals' | 'billing' | 'notifications'; children: ReactNode }) {
